...
export default function HomePage() {
  return (
    <div className="home">
      ...
      <footer>
        <div className="icons">
          {/* <img src="https://img.shields.io/github/stars/lencx/learn-wasm?label=stars%28learn-wasm%29" /> */}
          <a href="https://github.com/lencx/awesome-rsw"><img src={awesomeRswIcon} /></a>
        </div>
        <div className="f1">
